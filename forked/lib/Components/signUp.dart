...
Expanded(flex:3, child: Container(
  ...
  child: InkWell(
    ...
    child: RichText(text: TextSpan(text:"By siginning in you agree to our " , style: h4, 
    children:[TextSpan(text: "terms & condiotions",style: underline) ]),),
      onTap: () {
                          ...
                          builder: (context) => Container(
                            ...
                            child: ListView(
                              children: [
                                  ...
                                  children: [
                                    Container(
                                      padding: EdgeInsets.only(left: 10 , top:20),
                                        child: Text("By your use of this Platform, Agree to Agree to the Standard Terms and Conditions"
                                    ...
                                    Container(
                                      padding: EdgeInsets.only(right: 150),
                                        ...
                                        child: Text(" 1-Individual property"
                                      , style: TextStyle(fontSize:
                                     ...
                                     Container(
                                        ...
                                        child: Text("We provide you with the power to use the application and reuse some personal purposes only "
                                      , style: TextStyle(fontSize:
                                         20, fontWeight: FontWeight.normal,
                                          color: Color.fromARGB(255, 99, 94, 94)),),
                                    ),
                                     ...
                                     Container(
                                       padding: EdgeInsets.only(left: 10),
                                        child: Text("In the event that you use this application, you are prohibited from the following ..Using the app illegally "
                                      , style: TextStyle(fontSize:
                                         20, fontWeight: FontWeight.normal,
                                          color: Color.fromARGB(255, 99, 94, 94)),),
                                    ),
                                     ...
                                     Container(
                                      padding: EdgeInsets.only(left:10),
                                        child: Text("Remove the logos of copyright,operation, publishing, publishing rights or any other intellectual property logos from the application or intellectual "
                                      , style: TextStyle(fontSize:
                                         20, fontWeight: FontWeight.normal,
                                          color: Color.fromARGB(255, 99, 94, 94)),),
                                    ),
                                     ...
                                     Container(
                                      padding: EdgeInsets.only(right: 86),
                                        child: Text("Please read the privacy policy "
                                      , style: TextStyle(fontSize:
                                         20, fontWeight: FontWeight.normal,
                                          color: Color.fromARGB(255, 99, 94, 94)),),
                                    ),
                                     ...
                                     Container(
                                      padding: EdgeInsets.only(left:10),
                                        child: Text("Your content should be in me, the crown, your outreach, and the app."
                                      , style: TextStyle(fontSize:
                                         20, fontWeight: FontWeight.normal,
                                          color: Color.fromARGB(255, 99, 94, 94)),),
                                    ),
                                     ...
                                     Container(
                                      padding: EdgeInsets.only(left: 10),
                                        child: Text("It has the power to remove any of your content without notice"
                                      , style: TextStyle(fontSize:
                                         20, fontWeight: FontWeight.normal,
                                          color: Color.fromARGB(255, 99, 94, 94)),),
                                    ),
                                ...
                                SizedBox(height: 20,),
                                  Container(
                                    padding:EdgeInsets.only(left: 100,right: 100,top: 8,bottom: 5),
                                    decoration:BoxDecoration(
